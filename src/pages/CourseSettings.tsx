...
export default function CourseSettings() {
  ...
  // Fetch course offering and enrollments
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Fetch course offering to get userRole and course data
        ...
        if (offeringData.settings?.canView) {
          setSelectedViewableOfferings(offeringData.settings.canView);
        }
        ...
        try {
          ...
          const accessibleOfferings = allOfferingsResponse.data.filter(
            (off) => {
  ...
  }, [courseId, isAuthenticated, navigate, user?.role]);
  ...
  return (
    <div>
      ...
      <div className="container mx-auto p-6">
        {/* Show loading state while checking authentication and role or loading course offering */}
