...
export default function ProjectNotFound() {
  ...
  // Decode the team name in case it's URL encoded
  const decodedTeamName = team_name
    ? (() => {
        try {
          return decodeURIComponent(team_name);
        } catch {
      ...
      <div className="max-w-md w-full text-center space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600">
            {decodedTeamName ? (
              <>
                There is no project deployed at this location for{' '}
              ...
              'There is no project deployed at this location.'
            )}
          </p>
        </div>
